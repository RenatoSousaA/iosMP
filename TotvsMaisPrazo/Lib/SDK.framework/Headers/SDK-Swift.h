...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull KEYSWIFTDAP;)
+ (NSString * _Nonnull)KEYSWIFTDAP SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) id <SDKDelegate> _Nullable delegate;
...
- (void)onSuccessWithImgFront:(UIImage * _Nonnull)imgFront imgBack:(UIImage * _Nonnull)imgBack;
...
- (void)onSuccessWithDone:(BOOL)done;
- (void)onExit;
- (void)onErrorWithError:(enum SDKError)error;
@end

typedef SWIFT_ENUM(NSInteger, SDKError) {
