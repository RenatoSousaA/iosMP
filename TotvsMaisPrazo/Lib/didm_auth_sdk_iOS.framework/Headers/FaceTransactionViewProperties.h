...
#pragma mark - Dialog
/** Dialog **/
@property (nonatomic,strong) NSString *SERVER_RESPONSE_DIALOG_TITLE;
@property (nonatomic,strong) NSString *SERVER_RESPONSE_DIALOG_RETRY;
@property (nonatomic,strong) NSString *SERVER_RESPONSE_DIALOG_OK;
@property (nonatomic,strong) NSString *SERVER_RESPONSE_DIALOG_CANCEL;
